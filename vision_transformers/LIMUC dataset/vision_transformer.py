...
# class PatchEmbedding(nn.Module):
#     def __init__(self, img_size=224, patch_size=8, in_channels=3, embed_dim=512):  # Modified patch_size and embed_dim
#         super().__init__()
#         self.img_size = img_size
#         self.patch_size = patch_size
#         self.n_patches = (img_size // patch_size) ** 2
...
# class MultiheadAttention(nn.Module):
#     def __init__(self, embed_dim, num_heads, dropout=0.1):  # Increased base dropout
#         super().__init__()
#         self.embed_dim = embed_dim
#         self.num_heads = num_heads
#         self.head_dim = embed_dim // num_heads
...
# class TransformerBlock(nn.Module):
#     def __init__(self, embed_dim, num_heads, mlp_ratio=4.0, dropout=0.1):  # Increased dropout
#         super().__init__()
#         self.norm1 = nn.LayerNorm(embed_dim)
#         self.attn = MultiheadAttention(embed_dim, num_heads, dropout)
#         self.norm2 = nn.LayerNorm(embed_dim)
...
#         self.cls_token = nn.Parameter(torch.zeros(1, 1, embed_dim))
#         self.pos_embed = nn.Parameter(torch.zeros(1, self.patch_embed.n_patches + 1, embed_dim))
#         self.pos_drop = nn.Dropout(dropout)  # Added positional embedding dropout
...
# def train_and_evaluate(model, train_loader, val_loader, criterion, optimizer, 
#                       scheduler, num_epochs, device, patience=10):  # Increased patience
#     best_val_acc = 0
#     patience_counter = 0
